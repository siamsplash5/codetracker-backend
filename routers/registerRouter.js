...
registerRouter.post('/', async (req, res) => {
    try {
        ...
        if (existingUsername) return responseHandler.badRequest(res, 'This username is already in use.');
        ...
        if (message === 'otp already exist') return responseHandler.badRequest(res, 'OTP already sent.');
