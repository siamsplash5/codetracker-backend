    ...
    try {
        ...
        <html>
          ...
          <body>
            ...
            <p>This code is only valid for 1 hour. Thank you for choosing CodeTracker.</p>
            <p>If it was not you, just ignore this letter.</p>
            <p>With best regards,<br>CodeTracker Team.</p>
          </body>
        </html>`,
        };
    ...
    try {
        ...
        <html>
          ...
          <body>
            ...
            <p><b>Code:</b> ${otp}</p>
            <p>This code is only valid for 1 hour.</p>
